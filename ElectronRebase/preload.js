...
contextBridge.exposeInMainWorld('notchAPI', {
  ...
  listWindows: (options) => ipcRenderer.invoke('windows:list', options),
  ...
  warmPaimonSpeech: () => ipcRenderer.invoke('assistant:tts-warmup'),
  speakPaimon: (payload) => ipcRenderer.invoke('assistant:speak', payload),
  stopPaimonSpeech: () => ipcRenderer.invoke('assistant:speech-stop'),
  onPaimonSpeechEvent: (cb) => subscribe('assistant:speech-event', (event, payload) => cb(payload)),
