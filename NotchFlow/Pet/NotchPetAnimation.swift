...
enum NotchPetIdleChoreography {
    static let greetingWaveCycle = 2

    static func flourish(afterCompletedCycles count: Int) -> NotchPetMotion? {
        guard count > 0, count.isMultiple(of: greetingWaveCycle) else { return nil }
